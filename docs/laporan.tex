...
kemudian dari variabel variabel tersebut dijadikan argumen pada fungsi \texttt{\detokenize{check_user()}} yang maksukan ke dalam variael hasil yang digunakan untuk mengecek pada databases apakah ada username dan password seperti apa yang diinputkan .
